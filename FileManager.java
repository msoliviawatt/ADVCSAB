   ...
   public static Player readPlayerFromFile(String fileName)
   {
      try
      {
         ...
         //code to read potions from file: Line 4
            ...
            String [] pot = line.split(" ");
            if(pot.length != Potion.NUM_POTIONS) {
               return null;
            }
            ...
            if(flow.length != Player.NUM_FLOWERS) {
               return null;
            }
            for(int i =  0; i < flow.length; i++) {
               String p  = flow[i].trim();
               if(!wordIsInt(p)) {
                  return null;
               }
               flowerBoxCount[i] = Integer.parseInt(p);
            }
            //******************************************************************/
         ...
         //code to read specificExperience from file: Line 6
            ...
            String [] specEx = line.split(" ");
            if(specEx.length != 4) {
               return null;
            }
            for(int i =  0; i < specEx.length; i++) {
               String p  = specEx[i].trim();
               if(!wordIsInt(p)) {
                  return null;
               }
               specificExperience[i] = Integer.parseInt(p);
            }
            //******************************************************************/
            ...
            String [] statStuff = line.split(" ");
            if(statStuff.length != Player.NUM_STATS) {
               return null;
            }
            for(int i =  0; i < statStuff.length; i++) {
               String p  = statStuff[i].trim();
               if(!wordIsInt(p)) {
                  return null;
               }
               stats[i] = Integer.parseInt(p);
            }
            //******************************************************************/
            ...
            String [] indexThing = line.split(" ");
            if(indexThing.length != Player.NUM_INFO_INDEXES) {
               return null;
            }
            for(int i =  0; i < indexThing.length; i++) {
               String p  = indexThing[i].trim();
               if(!wordIsInt(p)) {
                  return null;
               }
               infoIndexes[i] = Integer.parseInt(p);
            }
            //******************************************************************/
          ...
          //code to read spellHotKeys from file: Line 9
            ...
            String [] shkeys = line.split(" ");
            if(shkeys.length != 4) {
               return null;
            }
            for(int i =  0; i < shkeys.length; i++) {
               String p  = shkeys[i].trim();
               if(!wordIsInt(p)) {
                  return null;
               }
               spellHotKeys[i] = Integer.parseInt(p);
            }
            //******************************************************************/
            ...
            String [] phkeys = line.split(" ");
            if(phkeys.length != Potion.NUM_POTIONS) {
               return null;
            }
            for(int i =  0; i < phkeys.length; i++) {
               String p  = phkeys[i].trim();
               if(!wordIsInt(p)) {
                  return null;
               }
               potionHotKeys[i] = Integer.parseInt(p);
            }
            //******************************************************************/
          ...
          //code to read weaponHotKeys from file: Line 11
            ...
            String [] whkeysstr = line.split(" ");
            int [] whkeysnum = new int[8];
            for(int i = 0; i < whkeysnum.length; i++) {
               String p = whkeysstr[i].trim();
               if(!wordIsInt(p)) {
                  return null;
               }
               whkeysnum[i] = Integer.parseInt(p);
            }
            for(int i = 0; i < weaponHotKeys.length - 1; i++) {
               weaponHotKeys[i] = new Point(whkeysnum[i], whkeysnum[i + 1]);
            }
            //******************************************************************/
          ...
          //code to read effects from file: Line 12
            ...
            String [] fnames = temp.split(",");
            for(int i = 0; i < fnames.length; i++) {
               String p = fnames[i].trim();
               fileNames.add(p);
            }
          ...
          //code to read items from file: Line 14
            ...
            temp = line.substring(1, line.indexOf("]"));
            String [] ilist =  temp.split(",");
            items = new ArrayList<String>();
            for(int i = 0; i < ilist.length; i++) {
               items.add(ilist[i].trim());
            }
            //******************************************************************/
            if(items==null)
            {
            ...
            temp = line.substring(1, line.indexOf("]"));
            String [] spellsArray = temp.split(",");
            for(int i = 0; i < spellsArray.length; i++) {
               spells.add(Spell.getSpellWithName(spellsArray[i].trim()));
            }
            //******************************************************************/
            if(spells==null)
            {
          ...
          //code to read teleporter memory from file: Line 16
            ...
            temp = line.substring(1, line.indexOf("]"));
            String [] memArray = temp.split(",");
            for(int i = 0; i < memArray.length; i++) {
               String [] helper = memArray[i].trim().substring(1, memArray[i].length() - 1).split(" ");
               int a = Integer.parseInt(helper[0]);
               int b = Integer.parseInt(helper[1]);
               int c = Integer.parseInt(helper[2]);
               String d = helper[3];
               Teleporter x = new Teleporter(a, b, c, d);
               memory.add(x);
            }
          ...
          //code to read armorSet and armorFreq from file: Line 17
            ...
            temp = line.substring(1, line.indexOf("]"));
            String [] aset = temp.split(",");
            armorSet = new ArrayList<Armor>();
            armorFreq = new ArrayList<Integer>();
            for(int i = 0; i < aset.length; i++) {
               String [] helper = aset[i].trim().split(":");
               int x = Integer.parseInt(helper[1]);
               armorSet.add(Armor.getArmorWithName(helper[0]));
               armorFreq.add(x);
          ...
          //code to read weapons and weaponFrequencies from file: Lines 18-32
            ...
            for(int i = 0; i < 15; i++) {
               ...
               temp = line.substring(1, line.indexOf("]"));
               String [] wps = temp.split(",");
               for(int j = 0; j < wps.length; j++) {
                  String [] helper = wps[j].trim().split(":");
                  weapons[i].add(Weapon.getWeaponWithName(helper[0]));
                  weaponFrequencies[i].add(Integer.parseInt(helper[1]));
               }
            }
            //**************************DONE!************************************/ 
